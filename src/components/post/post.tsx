...
const Post = ({ post, index }: PostProps) => {
  const { author: {shortAddress}, cid, content, downvoteCount, flair, link, linkHeight, linkWidth, replyCount, spoiler, subplebbitAddress, timestamp, title, upvoteCount } = post || {};
