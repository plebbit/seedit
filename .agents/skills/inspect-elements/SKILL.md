...
description: Map a visible seedit DOM node to its React source when file or component attribution is needed.
---
...
```bash
./scripts/pw-session.sh open inspect https://seedit.localhost/#/s/all
